const translations = {
  pt: {
    ...
    subtitle: "Preserve a qualidade e o valor da sua safra com a nossa tecnologia",
  ...
  en: {
    ...
    subtitle: "Keep your harvest’s quality and value with our advanced technology",
  ...
  es: {
    ...
    subtitle: "Mantenga la calidad y el valor de su cosecha con nuestra tecnología avanzada",
...
switcher.addEventListener("change", () => {
  ...
  document.querySelector(".nav-company").textContent = translations[lang].nav.company;
  document.querySelector(".nav-training").textContent = translations[lang].nav.training;
  document.querySelector(".nav-videos").textContent = translations[lang].nav.videos;
  document.querySelector(".nav-events").textContent = translations[lang].nav.events;
  document.querySelector(".nav-partners").textContent = translations[lang].nav.partners;
  ...
  document.querySelector(".footer-content p:first-child").innerHTML =
    `&copy; 2025 QualyAgro - ${translations[lang].footer1}`;
